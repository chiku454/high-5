...
export default class CorporatFrom extends React.Component{
    constructor(){
        super();
        this.state = {
            stepIndex: 0,
        ...
        return(
            <div>
                ...
                : <div>
                    ...
                    <Button variant="contained" color="primary" disableElevation style={{margin: "10px"}} onClick={() => this.props.history.push(`/orgDetail/${this.state.scf_id}`)}>See your Happay Score</Button>
                    </div> */}
